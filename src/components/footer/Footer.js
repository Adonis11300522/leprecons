      ...
      <div className="Footer-main">
        <Container className="Footer-main-body pt-4 pb-4">
            ...
            <div className="Footer-main-community mt-5">
                <NavLink href="https://twitter.com/Lying_Leprecons?t=Jp1X0fYow0rUePMfPLs1lA&s=09"><FaTwitter/></NavLink>
                <NavLink href="https://discord.gg/JCXW9Qucux"><FaDiscord/></NavLink>
            </div>
